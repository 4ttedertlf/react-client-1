  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to 4tt, accessible from{" "}
            <a
              href="https://4tt-1.azurewebsites.net"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://4tt-1.azurewebsites.net
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          ...
          <a
            href="https://4tt-1.azurewebsites.net/contact"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://4tt-1.azurewebsites.net/contact
          </a>
        </li>
      </ul>
    </div>
